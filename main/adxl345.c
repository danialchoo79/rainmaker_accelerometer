...
{
	return (swap_int16(i2c_read_short(i2c_master_port, ADXL345_ALT_SLAVE_ADDRESS, ADXL345_DATAX)));
}

int16_t adxl345_read_y(uint8_t i2c_master_port)
{
	return (swap_int16(i2c_read_short(i2c_master_port, ADXL345_ALT_SLAVE_ADDRESS, ADXL345_DATAY)));
}

int16_t adxl345_read_z(uint8_t i2c_master_port)
{
	return (swap_int16(i2c_read_short(i2c_master_port, ADXL345_ALT_SLAVE_ADDRESS, ADXL345_DATAZ)));
}
